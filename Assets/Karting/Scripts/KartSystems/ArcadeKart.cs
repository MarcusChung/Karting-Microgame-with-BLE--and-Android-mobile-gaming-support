...
namespace KartGame.KartSystems
{
    public class ArcadeKart : MonoBehaviour
    {
        ...
        bool m_HasCollision;
        public bool m_InAir { get; private set; } = false;
        ...
        public bool vCollisionCheck;
        public bool collisionDone;
        public string collisionObjectName { get; private set; }
        [SerializeField] private TMP_Text kartStatusText;

        public int collisionCount;
        //a function that stores collisionCount to the local android device
        void OnCollisionEnter(Collision collision)
        {
            Debug.Log("Player car collided with " + collision.gameObject.name);
            kartStatusText.text = "Player collided with " + collision.gameObject.name + " " + collisionCount;
            collisionObjectName = collision.gameObject.name;
            if (!collisionObjectName.StartsWith("PinWarner") && !collisionObjectName.StartsWith("CrashObject")
            && !collisionObjectName.StartsWith("PhysicsBall") && !collisionObjectName.StartsWith("StoneRound")
            && !collisionObjectName.StartsWith("AheadWarningStone")) collisionCount++;
            m_HasCollision = true;
        ...
        void OnCollisionExit(Collision collision)
        {
            ...
            collisionDone = false;
            // Debug.Log("vCollisionCheck status = " + vCollisionCheck);
        }
